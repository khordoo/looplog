...
export function Shell() {
  ...
  useEffect(() => {
    const titles: Array<[string, string]> = [['/today', 'Today'], ['/workout/', 'Active workout'], ['/exercises/', 'Exercise guide'], ['/exercises', 'Exercises'], ['/history/', 'Session details'], ['/history', 'History'], ['/settings/schedule', 'Schedule settings'], ['/settings/bands', 'Band settings'], ['/settings/substitutions', 'Substitution settings'], ['/settings/backups', 'Backup settings'], ['/settings/storage', 'Storage settings'], ['/settings/reset', 'Reset settings'], ['/settings', 'Settings'], ['/onboarding', 'Onboarding']]
